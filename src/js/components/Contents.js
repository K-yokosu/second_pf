...
class Content extends React.Component {
  keywordComponent = (keyword) => (<span className="main-contents__codeBox__keyword">{keyword}</span>)

  funcNameComponent = (funcName) => (<span className="main-contents__codeBox__function">{funcName}</span>)

  punctuationComponent = (punctuation) => (<span className="main-contents__codeBox__punctuation">{punctuation}</span>)

  operatorComponent = (operator) => (<span className="main-contents__codeBox__operator">{operator}</span>)

  stringComponent = (string) => (<span className="main-contents__codeBox__string">{string}</span>)
  ...
  attributeElementComponent = (element, attribute, string) => (
    <>
      {this.punctuationComponent('<')}
      <span className="main-contents__codeBox__element">{element}</span>
      <span className="main-contents__codeBox__attribute">
        {' '}
        {attribute}
      </span>
  ...
  render() {
    // 最後にコメント確認する
    // 文章のインデントつける
    // contentsの左右にアロー置いて、押したら次とか前のぺーじ行けるみたいなこれはrouter勉強してからかな
        ...
        <div className="main-contents__chapterBox">
          ...
          <div className="main-contents__subChapterBox">
            ...
            <div className="main-contents__indent">
              ...
              <p className="main-contents__sentences">
                <strong>補足: コンポーネント名は常に大文字で始めてください。</strong>
                <br />
                ...
                はコンポーネントを表しており、
                <span className="main-contents__no">スコープ内に Welcome が存在する必要</span>
                があります。
              </p>
            </div>
          </div>
        ...
        <div className="main-contents__chapterBox">
          ...
          <div className="main-contents__subChapterBox">
            ...
            <div className="main-contents__indent">
              ...
              <p className="main-contents__sentences">
                ...
                <a href="https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/super">super</a>
                の呼び出しを強制します。
          ...
          <div className="main-contents__subChapterBox">
            ...
            <div className="main-contents__indent">
              ...
              <p className="main-contents__sentences">
                上記のコードでは
                <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_functions">アロー関数</a>
          ...
          <div className="main-contents__subChapterBox">
            ...
            <div className="main-contents__indent">
              <p className="main-contents__sentences">
                ...
                {this.punctuationComponent('"/"')}
                {' '}
                は常に一致することになるので、通常この path を持つ Route は最後に配置します。
    ...
    return (
      ...
      <>
        {setContents === 'scss' && (<>{scssContents}</>)}
        {setContents === 'js' && (<>{jsContents}</>)}
        {setContents === 'react' && (<>{reactContents}</>)}
        {setContents === 'router' && (<>{routerContents}</>)}
      </>
    );
  }
}
Content.propTypes = {
  titles: PropTypes.oneOfType([PropTypes.object]).isRequired,
  setContents: PropTypes.string.isRequired,
};
